...
public class UserProfileResponse {
    ...
    public UserProfileResponse(String id, String email, String name, String phone, String address, String dob, Double height, String gender, String eyeColor, String bloodGroup, ArrayList<VehicleSchema> vehicles, ArrayList<SubscribedPackageSchema> subscribedPackages) {
        this.id = id;
        this.email = email;
        this.name = name;
        this.phone = phone;
