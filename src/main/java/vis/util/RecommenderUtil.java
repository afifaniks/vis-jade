...
public class RecommenderUtil {
     ...
     */
    public static ArrayList<InsurancePackageSchema> generateRecommendation(String birthdate, VehicleEntity vehicleEntity, List<InsurancePackageEntity> entities) {
