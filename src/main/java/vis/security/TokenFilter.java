...
public class TokenFilter implements Filter {
     ...
     */
    private List<String> protectedRoutes = Arrays.asList(APIRoutes.SUBSCRIBE, APIRoutes.REGISTER_VEHICLE, APIRoutes.GET_PACKAGES, APIRoutes.CLAIM, APIRoutes.PROFILE, APIRoutes.GET_USER);
