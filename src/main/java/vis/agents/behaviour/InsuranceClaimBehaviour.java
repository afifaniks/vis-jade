        ...
        try {
            if (receivedMessage.getPerformative() == ACLMessage.REQUEST) {
                ...
                if (actionContent.getAction() instanceof ClaimInsurance) {
                    ...
                    InsuranceClaimStatusSchema claimStatus = insuranceClaimService.claimInsurance(new ClaimRequestSchema(claimInsurance.getUser().getUserId(), claimInsurance.getSubscription().getSubscriptionId()));
